...
class CloseIcon extends React.Component {
  ...
  render() {
    return (
      <button 
        id="closeButton" onClick={this.props.onClick} onMouseEnter={this.mauseEnter.bind(this)} 
        onMouseLeave={this.mauseEnter.bind(this)}
      >
        ...
        >
        <path id={this.state.hovered ? 'closeIcon-hovered' : 'closeIcon'}
