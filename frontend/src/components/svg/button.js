...
class ButtonImage extends React.Component {
  render() {
    return (
      ...
      >
        <path id={this.props.id} className={this.props.className ? this.props.className : 'buttonPath'}
        ...
        />
        <text id={this.props.id} className="buttonCaption" x="50%" y="50%" dominantBaseline="central" textAnchor="middle">
          {this.props.caption}
        </text>
      </svg>
    );
