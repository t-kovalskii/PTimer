...
// svg code of GitHub logo
export default class GitHubLogo extends React.Component {
  render() {
    return(
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" 
        width={this.props.size + 'px'} height={this.props.size + 'px'} viewBox="0 0 32.58 31.77" 
        style={{enableBackground: 'new 0 0 32.58 31.77'}} xmlSpace="preserve" className="githubPath"
      >
        <path 
